...
def sample_docx():
    ...
    with tempfile.NamedTemporaryFile(suffix='.docx', delete=False) as tmp_file:
        doc = Document()
        doc.add_paragraph("This is a test document with some keywords like Python, NLP, and Image Processing.")
        doc.add_picture('tests/resources/test_image.png')  # Ensure you have a test image in this path
...
def test_highlight_keywords_in_image(processor, tmp_path):
    ...
    highlighted_path = processor.highlight_keywords_in_image(str(test_image_path), keywords)
